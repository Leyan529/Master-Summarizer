...
loggerName = loggerName.replace('Pointer_generator','Normal_Seq2Seq')
writerPath = writerPath.replace('Pointer-Generator','Normal_Seq2Seq')
...
from create_model.seq2seq import Modelimport torch.nn as nn
import torch as T
