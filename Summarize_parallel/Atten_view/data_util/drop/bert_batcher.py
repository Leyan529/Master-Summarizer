  ...
  def text_generator(self, example_generator):
    while True:
      ...
      try:
        ...
        review_text = e.features.feature['bert_review'].bytes_list.value[0]  # the review text was saved under the key 'review' in the bert_data files
        # summary_text = b' <s> solid value performer </s> '
        summary_text = e.features.feature['bert_summary'].bytes_list.value[0]  # the summary text was saved under the key 'summary' in the bert_data files
