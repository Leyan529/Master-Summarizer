...
# 		host = '140.116.39.2'
	...
	def make_index(self, db_col='Prod_Review'):
		...
		mongo_coll.create_index([('asin', pymongo.TEXT),
								 ('main_helpful', pymongo.TEXT),
								 ('overall', pymongo.TEXT),
								 # ('review_token_len', pymongo.TEXT),
								 # ('summary_token_len', pymongo.TEXT),
								 # ('desc_token_len', pymongo.TEXT),
								 # ('title', pymongo.TEXT),
								 ('big_categories', pymongo.TEXT),
								 ('small_categories', pymongo.TEXT)])  # 对名为field的项建立文档索引
