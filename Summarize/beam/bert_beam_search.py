...
def beam_search(enc_hid, enc_out, enc_padding_mask, ct_e, extra_zeros, enc_batch_extend_vocab, enc_key_batch, enc_key_lens, model, start_id, end_id, unk_id):
    ...
    for t in range(config.max_dec_steps):
        ...
        final_dist, (dec_h, dec_c), ct_e, sum_temporal_srcs, prev_s = model.decoder(x_t, s_t, enc_out_beam, enc_pad_mask_beam, ct_e, extra_zeros_beam, enc_extend_vocab_beam, sum_temporal_srcs, prev_s, enc_key_batch, enc_key_lens)              #final_dist: rem*beam, n_extended_vocab
